import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as e}from"./app-Dr7nuJ7r.js";const t={},p=e(`<h1 id="策略模式实现多种支付" tabindex="-1"><a class="header-anchor" href="#策略模式实现多种支付"><span>策略模式实现多种支付</span></a></h1><p>最近开发完成的项目中使用到了<strong>策略模式</strong>，实现多种支付方式，避免了后期支付方式if-else代码的冗余，也有利于后期支付的一个扩展。同时这个项目非常适合于做毕设，想了解这个项目的同学可以联系我QQ：<strong>3808898981</strong></p><p><strong>前台首页</strong></p><img src="https://ice.frostsky.com/2024/03/19/e6466dcfd4190c03c8634635e14b5831.png" alt="前台首页" style="zoom:50%;"><p><strong>后台管理员</strong></p><img src="https://ice.frostsky.com/2024/03/19/6443a37348b59cd12ff0e8cb512a3b21.png" alt="后台管理员端" style="zoom:50%;"><p><strong>后台商户端</strong></p><img src="https://ice.frostsky.com/2024/03/19/100ba6575d4378e8c3f11f7583e76001.png" alt="商户管理端" style="zoom:50%;"><h1 id="什么是策略模式呢" tabindex="-1"><a class="header-anchor" href="#什么是策略模式呢"><span>什么是策略模式呢？</span></a></h1><p><strong>策略模式（Strategy Design Pattern）</strong>，定义一堆算法类，并将每个算法分别封装起来，让它们可以互相替换，被封装起来的算法具有独立性外部不可改变其特性。</p><p>策略模式可以使算法的变化独立于使用它们的客户端（这里的客户端代指使用算法的代码）。</p><p><strong>策略模式的应用场景</strong> 策略模式最常见的应用场景是，利用它来避免冗长的 if-else 或 switch 分支判断。不过，它的作用还不止如此。它也可以像模板模式那样，提供框架的扩展点等等。</p><p>当我们需要多个功能相似的类，并且需要它们之间可以灵活切换时，就非常适合使用策略模式。</p><p><strong>策略模式的构成</strong> 策略类的定义比较简单，需要定义以下两种角色：</p><ul><li>抽象策略接口类：定义了策略类需要实现的方法规范。</li><li>策略实现类：继承自抽象策略接口，为具体策略类。</li><li>当有多个策略时，可以通过简单工厂封装所有的策略，使调用更加易用：</li></ul><p>策略工厂类：一般来说，通过一个策略工厂，将一群功能相同的策略封装起来，调用更加方便。 通过一个文件处理的例子来说明；有一个文件处理的通用类，可以处理excel、txt、exe文件。 面对不同类型的文件，返回具体对应的文件处理类，也就是具体的策略类。</p><h1 id="实战" tabindex="-1"><a class="header-anchor" href="#实战"><span>实战</span></a></h1><blockquote><p><strong>支付实体类</strong></p></blockquote><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * @Author: @weixueshi
